...
# Scrapy settings for FangTianXiaDistributedSpider project
#
...
BOT_NAME = 'FangTianXiaDistributedSpider'

SPIDER_MODULES = ['FangTianXiaDistributedSpider.spiders']
NEWSPIDER_MODULE = 'FangTianXiaDistributedSpider.spiders'

# Crawl responsibly by identifying yourself (and your website) on the user-agent
# USER_AGENT = 'FangTianXiaDistributedSpider (+http://www.yourdomain.com)'
...
# scrapy-redis相关配置
# 确保request存储到redis数据库中
SCHEDULER = "scrapy_redis.scheduler.Scheduler"
# 爬虫共享指纹去重
DUPEFILTER_CLASS = "scrapy_redis.dupefilter.RFPDupeFilter"
# 不会清理redis中队列，可以实现暂停和恢复功能
SCHEDULER_PERSIST = True  # 默认为False 分布式爬虫层序结束redis中的请求指纹dupefilter,request请求队列会自动清空
...
# SPIDER_MIDDLEWARES = {
#    'FangTianXiaDistributedSpider.middlewares.FangtianxiaspiderSpiderMiddleware': 543,
# }

# Enable or disable downloader middlewares
# See https://doc.scrapy.org/en/latest/topics/downloader-middleware.html
# DOWNLOADER_MIDDLEWARES = {
#    'FangTianXiaDistributedSpider.middlewares.RandomUADownloaderMiddleware': 543,
# }
...
ITEM_PIPELINES = {
   'FangTianXiaDistributedSpider.pipelines.FangTianXiaMongoDBPipeline': 300,
   'FangTianXiaDistributedSpider.pipelines.FangTianXiaMySQLPipeline': 303,

   # 开启分布式slavers抓取的数据都会保存到redis数据库中，看情况，一般不建议开启<因为redis走内存[支持持久化存储]，资源有点浪费>
