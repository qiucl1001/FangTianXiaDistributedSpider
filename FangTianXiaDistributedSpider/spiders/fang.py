...
from FangTianXiaDistributedSpider.items import NewHouseFangItem, EsfFangItem
...
class FangSpider(RedisSpider):
    ...
    # 分布式爬虫抓取启动命令---> master端redis指令：FangSpider:start_urls lpush "https://www.fang.com/SoufunFamily.htm"
